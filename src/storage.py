...
# Insert or update in a single statement — the pipeline is idempotent because
# re-running with the same asset_id updates the existing row rather than
...
INSERT INTO bi_assets (
    ...
    owner, last_refresh_at, status, source_system, ingested_at
) VALUES (
    :asset_id, :asset_name, :workspace_id, :workspace_name, :dataset_id,
    :owner, :last_refresh_at, :status, :source_system, :ingested_at
)
